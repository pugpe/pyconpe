...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.type'
        db.alter_column('submission_vote', 'type', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Vote.type'
        db.alter_column('submission_vote', 'type', self.gf('django.db.models.fields.CharField')(max_length=3))
